...
const RegistrationForm = () => {
    ...
    return (
        <div className="container mx-auto mt-8 md:mt-14 mb-8 md:mb-16 px-4">
            <Helmet>
            ...
            <div className="max-w-3xl mx-auto p-5 md:p-8 shadow-lg rounded-lg border">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="form-group">
                        ...
                        <input type="text" name="firstName" value={formData.firstName} onChange={handleChange} className="w-full p-3 border rounded-lg" placeholder="First Name" required />
                    </div>
                    <div className="form-group">
                        <label>Last Name</label>
                        <input type="text" name="lastName" value={formData.lastName} onChange={handleChange} className="w-full p-3 border rounded-lg" placeholder="Last Name" required />
                    </div>
                    <div className="form-group">
                        <label>Contact Number</label>
                        <input type="text" name="number" value={formData.number} onChange={handleChange} className="w-full p-3 border rounded-lg" placeholder="Contact Number" required />
                    </div>
                    <div className="form-group">
                        <label>Email</label>
                        <input type="email" value={user?.email || ""} readOnly className="w-full p-3 border rounded-lg cursor-not-allowed" />
                    </div>
                    <div className="form-group">
                        <label>Marathon Title</label>
                        <input type="text" value={title} readOnly className="w-full p-3 border rounded-lg cursor-not-allowed" />
                    </div>
                    <div className="form-group">
                        <label>Start Date</label>
                        <input type="text" value={new Date(marathonStartDate).toLocaleDateString()} className="w-full p-3 border rounded-lg cursor-not-allowed" readOnly />
                    </div>
                    <div className="form-group md:col-span-2">
                        <label>Additional Info</label>
                        <textarea name="additionalInfo" value={formData.additionalInfo} onChange={handleChange} className="w-full p-3 border rounded-lg resize-none" placeholder="Additional Info" rows="4" required></textarea>
                    </div>
                    <div className="md:col-span-2">
                        <button type="submit" className="btn w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition-all duration-500">
                            Submit Now
                        </button>
                    </div>
                </form>
